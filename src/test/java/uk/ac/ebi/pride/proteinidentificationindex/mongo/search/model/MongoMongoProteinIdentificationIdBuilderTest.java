...
public class MongoMongoProteinIdentificationIdBuilderTest {
  ...
  private static final String ID =
      PROTEIN_ACCESSION + MongoProteinIdentificationIdBuilder.SEPARATOR
          + PROJECT_ACCESSION + MongoProteinIdentificationIdBuilder.SEPARATOR
          + ASSAY_ACCESSION;

  @Test
  public void testGetId() throws Exception {
    String newID = MongoProteinIdentificationIdBuilder.getId(PROTEIN_ACCESSION,PROJECT_ACCESSION,ASSAY_ACCESSION);
